...
from controllers.home_controller import index, image, get_image, date_image, new, create, show_photos, edit, update, delete, favourite
...
home_routes.route('/<id>/favourite', methods=["POST"])(favourite)